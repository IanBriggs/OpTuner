...
fp64 ord_01_cos_fp64(fp64 xin) {
  fp64 x = xin + HPI_fp64;
  return x * 0x1.7e34abc1d739cp-1;
}
fp64 rord_05_cos_fp64(fp64 x) {
  if (x < HPI_fp64) {
    return ord_05_cos_fp64(x);
  }
  ...
  fp64 result = ord_05_cos_fp64(z);
  if (part == 2 || part == 3) {
    result *= (fp64) -1.0;  }
  return result;
}
fp64 rord_07_cos_fp64(fp64 x) {
  if (x < HPI_fp64) {
    return ord_07_cos_fp64(x);
  }
  int k = (int) (x / HPI_fp64);
  fp64 whole = ((fp64) k) * HPI_fp64;
  fp64 y = x - whole;
  ...
  fp64 result = ord_07_cos_fp64(z);
  if (part == 2 || part == 3) {
    result *= (fp64) -1.0;  }
  return result;
}
fp64 rord_03_cos_fp64(fp64 x) {
  if (x < HPI_fp64) {
    return ord_03_cos_fp64(x);
  }
  int k = (int) (x / HPI_fp64);
  fp64 whole = ((fp64) k) * HPI_fp64;
  fp64 y = x - whole;
  ...
  fp64 result = ord_03_cos_fp64(z);
  if (part == 2 || part == 3) {
    result *= (fp64) -1.0;  }
  return result;
}
fp64 rord_09_cos_fp64(fp64 x) {
  if (x < HPI_fp64) {
    return ord_09_cos_fp64(x);
  }
  int k = (int) (x / HPI_fp64);
  fp64 whole = ((fp64) k) * HPI_fp64;
  fp64 y = x - whole;
  ...
  fp64 result = ord_09_cos_fp64(z);
  if (part == 2 || part == 3) {
    result *= (fp64) -1.0;  }
  return result;
}
fp64 rord_11_cos_fp64(fp64 x) {
  if (x < HPI_fp64) {
    return ord_11_cos_fp64(x);
  }
  int k = (int) (x / HPI_fp64);
  fp64 whole = ((fp64) k) * HPI_fp64;
  fp64 y = x - whole;
  ...
  fp64 result = ord_11_cos_fp64(z);
  if (part == 2 || part == 3) {
    result *= (fp64) -1.0;  }
  return result;
}
fp64 rord_13_cos_fp64(fp64 x) {
  if (x < HPI_fp64) {
    return ord_13_cos_fp64(x);
  }
  int k = (int) (x / HPI_fp64);
  fp64 whole = ((fp64) k) * HPI_fp64;
  fp64 y = x - whole;
  ...
  fp64 result = ord_13_cos_fp64(z);
  if (part == 2 || part == 3) {
    result *= (fp64) -1.0;  }
  return result;
}
fp64 rord_15_cos_fp64(fp64 x) {
  if (x < HPI_fp64) {
    return ord_15_cos_fp64(x);
  }
  int k = (int) (x / HPI_fp64);
  fp64 whole = ((fp64) k) * HPI_fp64;
  fp64 y = x - whole;
  ...
  fp64 result = ord_15_cos_fp64(z);
  if (part == 2 || part == 3) {
    result *= (fp64) -1.0;  }
  return result;
}
fp64 rord_17_cos_fp64(fp64 x) {
  if (x < HPI_fp64) {
    return ord_17_cos_fp64(x);
  }
  int k = (int) (x / HPI_fp64);
  fp64 whole = ((fp64) k) * HPI_fp64;
  fp64 y = x - whole;
  ...
  fp64 result = ord_17_cos_fp64(z);
  if (part == 2 || part == 3) {
    result *= (fp64) -1.0;  }
  return result;
}
fp64 rord_19_cos_fp64(fp64 x) {
  if (x < HPI_fp64) {
    return ord_19_cos_fp64(x);
  }
  int k = (int) (x / HPI_fp64);
  fp64 whole = ((fp64) k) * HPI_fp64;
  fp64 y = x - whole;
  ...
  fp64 result = ord_19_cos_fp64(z);
  if (part == 2 || part == 3) {
    result *= (fp64) -1.0;  }
  return result;
}
fp64 rord_01_cos_fp64(fp64 x) {
  if (x < HPI_fp64) {
    return ord_01_cos_fp64(x);
  }
  int k = (int) (x / HPI_fp64);
  fp64 whole = ((fp64) k) * HPI_fp64;
  fp64 y = x - whole;

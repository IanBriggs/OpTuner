 ...
 *   scripts/ml_log.py --precision double --output src/ml_log_12.c \
 *     --poly-degree 12 --fname ml_log_12 --verbose Info
 * 
**/
#include <stdint.h>
#include <fenv.h>
...
static const double ml_log_12_inv_table[128][2]  = {
    { 0.0, 0.0},
        ...
        if (__builtin_expect(nan_or_inf, 0)) {
            ...
            if (__builtin_expect(vx_subnormal, 0)) {
                ...
                if (__builtin_expect(vx_zero, 0)) {
                    ...
                    log_inv_hi = ml_log_12_inv_table[table_index][INT32_C(0)];
                    tmp3 =  - log_inv_hi;
                    id_tmp = _vx_mant;
                    ...
                    tmp19 = _red_vx2_ * tmp18;
                    tmp20 = tmp17 + tmp19;
                    tmp21 = 0x1.99999999b8138p-3 * _red_vx;
                    tmp22 = -0x1.5555555555555p-3 * _red_vx;
                    tmp23 = _red_vx * tmp22;
                    tmp24 = tmp21 + tmp23;
                    tmp25 = 0x1.24922aaaac557p-3 * _red_vx;
                    tmp26 = _red_vx2_ * tmp25;
                    tmp27 = tmp24 + tmp26;
                    _red_vx3_ = _red_vx * _red_vx2_;
                    tmp28 = _red_vx3_ * tmp27;
                    tmp29 = tmp20 + tmp28;
                    tmp30 = -0x1.0000000005c69p-3 * _red_vx;
                    tmp31 = 0x1.e2d1142c42241p-4 * _red_vx;
                    tmp32 = _red_vx * tmp31;
                    tmp33 = tmp30 + tmp32;
                    tmp34 = -0x1.999995965c36ep-4 * _red_vx;
                    tmp35 = _red_vx2_ * tmp34;
                    tmp36 = tmp33 + tmp35;
                    tmp37 = -0x1.76ba44a988008p6 * _red_vx;
                    tmp38 = -0x1.55cccd96a098ep-4 * _red_vx;
                    tmp39 = _red_vx * tmp38;
                    tmp40 = tmp37 + tmp39;
                    tmp41 = 0x1.e01decec8758p18 * _red_vx;
                    tmp42 = _red_vx2_ * tmp41;
                    tmp43 = tmp40 + tmp42;
                    tmp44 = _red_vx3_ * tmp43;
                    tmp45 = tmp36 + tmp44;
                    _red_vx6_ = _red_vx3_ * _red_vx3_;
                    tmp46 = _red_vx6_ * tmp45;
                    poly = tmp29 + tmp46;
                    tmp47 = _red_vx * poly;
                    log_inv_lo = ml_log_12_inv_table[table_index][INT32_C(1)];
                    _vx_exp = ml_exp_extraction_dirty_fp64(tmp);
                    tmp48 = _vx_exp + INT32_C(-100);
                    id_tmp2 = tmp48;
                    tmp49 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                    tmp50 = tmp49 - log_inv_lo;
                    tmp51 = tmp47 + tmp50;
                    tmp52 = _red_vx + tmp51;
                    pre_result = tmp3 + tmp52;
                    exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
                    tmp53 = exact_log2_hi_exp + pre_result;
                    return tmp53;
                }
            } else {
                int vx_one;
                ...
                if (__builtin_expect(vx_one, 0)) {
                    ...
                    if (__builtin_expect(exp_minus_one, 0)) {
                        ...
                        tmp47 = poly * _red_vx;
                        tmp48 = _red_vx + tmp47;
                        tmp49 = tmp48 - -0x1.8432a1b0e2634p-43;
                        tmp50 = tmp49 - log_inv_lo;
                        result2 = tmp3 + tmp50;
                        return result2;
                    } else {
                        ...
                        _red_vx2_ = _red_vx * _red_vx;
                        tmp18 = _red_vx2_ * tmp17;
                        tmp19 = tmp16 + tmp18;
                        tmp20 = 0x1.99999999b8138p-3 * _red_vx;
                        tmp21 = -0x1.5555555555555p-3 * _red_vx;
                        tmp22 = _red_vx * tmp21;
                        tmp23 = tmp20 + tmp22;
                        tmp24 = 0x1.24922aaaac557p-3 * _red_vx;
                        tmp25 = _red_vx2_ * tmp24;
                        tmp26 = tmp23 + tmp25;
                        _red_vx3_ = _red_vx * _red_vx2_;
                        tmp27 = _red_vx3_ * tmp26;
                        tmp28 = tmp19 + tmp27;
                        tmp29 = -0x1.0000000005c69p-3 * _red_vx;
                        tmp30 = 0x1.e2d1142c42241p-4 * _red_vx;
                        tmp31 = _red_vx * tmp30;
                        tmp32 = tmp29 + tmp31;
                        tmp33 = -0x1.999995965c36ep-4 * _red_vx;
                        tmp34 = _red_vx2_ * tmp33;
                        tmp35 = tmp32 + tmp34;
                        tmp36 = -0x1.76ba44a988008p6 * _red_vx;
                        tmp37 = -0x1.55cccd96a098ep-4 * _red_vx;
                        tmp38 = _red_vx * tmp37;
                        tmp39 = tmp36 + tmp38;
                        tmp40 = 0x1.e01decec8758p18 * _red_vx;
                        tmp41 = _red_vx2_ * tmp40;
                        tmp42 = tmp39 + tmp41;
                        tmp43 = _red_vx3_ * tmp42;
                        tmp44 = tmp35 + tmp43;
                        _red_vx6_ = _red_vx3_ * _red_vx3_;
                        tmp45 = _red_vx6_ * tmp44;
                        poly = tmp28 + tmp45;
                        tmp46 = _red_vx * poly;
                        log_inv_lo = ml_log_12_inv_table[table_index][INT32_C(1)];
                        _vx_exp = ml_exp_extraction_dirty_fp64(x);
                        id_tmp2 = _vx_exp;
                        tmp47 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                        tmp48 = tmp47 - log_inv_lo;
                        tmp49 = tmp46 + tmp48;
                        tmp50 = _red_vx + tmp49;
                        pre_result = tmp2 + tmp50;
                        exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
...
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassSubExpressionSharing object at 0x7f714257b910> at <class 'metalibm_core.core.passes.PassScheduler.Optimization'>
//Info: inserting instantiate abstract precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiateAbstractPrecision object at 0x7f714257b550> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting instantiate precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiatePrecision object at 0x7f714257b460> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting target support check pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassCheckProcessorSupport object at 0x7f714257b280> at <class 'metalibm_core.core.passes.PassScheduler.JustBeforeCodeGen'>
...
//Info: executing pass instantiate_abstract_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f714257b0a0>
//Info: executing pass instantiate_abstract_prec on fct ml_log_12
//Info: executing pass: instantiate_prec
//Info: executing pass instantiate_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f714257b0a0>
//Info: executing pass instantiate_prec on fct ml_log_12
//Info: Applying <Optimization> stage passes
//Info: executing pass: sub_expr_sharing
//Info: executing pass sub_expr_sharing on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f714257b0a0>
//Info: executing pass sub_expr_sharing on fct ml_log_12
//Info: Applying <JustBeforeCodeGen> stage passes
//Info: executing pass: check_processor_support
//Info: executing pass check_processor_support on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f714257b0a0>
//Info: executing pass check_processor_support on fct ml_log_12
//Info: executing check-processor with target generic
//Info: checking processor support: <class 'metalibm_core.code_generation.generic_processor.GenericProcessor'>
//Info: executing pass: debug_tag_node
//Info: executing pass debug_tag_node on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f714257b0a0>
//Info: executing pass debug_tag_node on fct ml_log_12
//Info: Generating Source Code 
//Info: Generating C_Code code in src/ml_log_12.c

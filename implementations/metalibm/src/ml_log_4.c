 ...
 *   scripts/ml_log.py --precision double --output src/ml_log_4.c \
 *     --poly-degree 4 --fname ml_log_4 --verbose Info
 * 
**/
#include <stdint.h>
#include <fenv.h>
...
static const double ml_log_4_inv_table[128][2]  = {
    { 0.0, 0.0},
        ...
        if (__builtin_expect(nan_or_inf, 0)) {
            ...
            if (__builtin_expect(vx_subnormal, 0)) {
                ...
                if (__builtin_expect(vx_zero, 0)) {
                    ...
                    log_inv_hi = ml_log_4_inv_table[table_index][INT32_C(0)];
                    tmp3 =  - log_inv_hi;
                    id_tmp = _vx_mant;
                    ...
                    tmp14 = -0x1.fffffffcaa9cap-2 * _red_vx;
                    tmp15 = 0x1.5555555030a8cp-2 * _red_vx;
                    tmp16 = _red_vx * tmp15;
                    tmp17 = tmp14 + tmp16;
                    tmp18 = -0x1.0003555fd8de4p-2 * _red_vx;
                    tmp19 = 0x1.99a0afa5f34cdp-3 * _red_vx;
                    tmp20 = _red_vx * tmp19;
                    tmp21 = tmp18 + tmp20;
                    ...
                    poly = tmp17 + tmp22;
                    tmp23 = _red_vx * poly;
                    log_inv_lo = ml_log_4_inv_table[table_index][INT32_C(1)];
                    _vx_exp = ml_exp_extraction_dirty_fp64(tmp);
                    tmp24 = _vx_exp + INT32_C(-100);
                    id_tmp2 = tmp24;
                    tmp25 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                    tmp26 = tmp25 - log_inv_lo;
                    tmp27 = tmp23 + tmp26;
                    tmp28 = _red_vx + tmp27;
                    pre_result = tmp3 + tmp28;
                    exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
                    tmp29 = exact_log2_hi_exp + pre_result;
                    return tmp29;
                }
            } else {
                int vx_one;
                ...
                if (__builtin_expect(vx_one, 0)) {
                    ...
                    if (__builtin_expect(exp_minus_one, 0)) {
                        ...
                        tmp23 = poly * _red_vx;
                        tmp24 = _red_vx + tmp23;
                        tmp25 = tmp24 - -0x1.8432a1b0e2634p-43;
                        tmp26 = tmp25 - log_inv_lo;
                        result2 = tmp3 + tmp26;
                        return result2;
                    } else {
                        ...
                        tmp13 = -0x1.fffffffcaa9cap-2 * _red_vx;
                        tmp14 = 0x1.5555555030a8cp-2 * _red_vx;
                        tmp15 = _red_vx * tmp14;
                        tmp16 = tmp13 + tmp15;
                        tmp17 = -0x1.0003555fd8de4p-2 * _red_vx;
                        tmp18 = 0x1.99a0afa5f34cdp-3 * _red_vx;
                        tmp19 = _red_vx * tmp18;
                        tmp20 = tmp17 + tmp19;
                        _red_vx2_ = _red_vx * _red_vx;
                        ...
                        id_tmp2 = _vx_exp;
                        tmp23 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                        tmp24 = tmp23 - log_inv_lo;
                        tmp25 = tmp22 + tmp24;
                        tmp26 = _red_vx + tmp25;
                        pre_result = tmp2 + tmp26;
                        exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
...
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassSubExpressionSharing object at 0x7f381e592910> at <class 'metalibm_core.core.passes.PassScheduler.Optimization'>
//Info: inserting instantiate abstract precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiateAbstractPrecision object at 0x7f381e592550> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting instantiate precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiatePrecision object at 0x7f381e592460> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting target support check pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassCheckProcessorSupport object at 0x7f381e592280> at <class 'metalibm_core.core.passes.PassScheduler.JustBeforeCodeGen'>
...
//Info: executing pass instantiate_abstract_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f381e5920a0>
//Info: executing pass instantiate_abstract_prec on fct ml_log_4
//Info: executing pass: instantiate_prec
//Info: executing pass instantiate_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f381e5920a0>
//Info: executing pass instantiate_prec on fct ml_log_4
//Info: Applying <Optimization> stage passes
//Info: executing pass: sub_expr_sharing
//Info: executing pass sub_expr_sharing on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f381e5920a0>
//Info: executing pass sub_expr_sharing on fct ml_log_4
//Info: Applying <JustBeforeCodeGen> stage passes
//Info: executing pass: check_processor_support
//Info: executing pass check_processor_support on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f381e5920a0>
//Info: executing pass check_processor_support on fct ml_log_4
//Info: executing check-processor with target generic
//Info: checking processor support: <class 'metalibm_core.code_generation.generic_processor.GenericProcessor'>
//Info: executing pass: debug_tag_node
//Info: executing pass debug_tag_node on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f381e5920a0>
//Info: executing pass debug_tag_node on fct ml_log_4
//Info: Generating Source Code 
//Info: Generating C_Code code in src/ml_log_4.c

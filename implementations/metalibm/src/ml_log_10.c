 ...
 *   scripts/ml_log.py --precision double --output src/ml_log_10.c \
 *     --poly-degree 10 --fname ml_log_10 --verbose Info
 * 
**/
#include <stdint.h>
#include <fenv.h>
...
static const double ml_log_10_inv_table[128][2]  = {
    { 0.0, 0.0},
        ...
        if (__builtin_expect(nan_or_inf, 0)) {
            ...
            if (__builtin_expect(vx_subnormal, 0)) {
                ...
                if (__builtin_expect(vx_zero, 0)) {
                    ...
                    log_inv_hi = ml_log_10_inv_table[table_index][INT32_C(0)];
                    tmp3 =  - log_inv_hi;
                    id_tmp = _vx_mant;
                    ...
                    tmp22 = -0x1.5555555555654p-3 * _red_vx;
                    tmp23 = _red_vx * tmp22;
                    tmp24 = tmp21 + tmp23;
                    _red_vx3_ = _red_vx * _red_vx2_;
                    tmp25 = _red_vx3_ * tmp24;
                    tmp26 = tmp20 + tmp25;
                    tmp27 = 0x1.24923aebad86cp-3 * _red_vx;
                    tmp28 = -0x1.ffffffdd4c37cp-4 * _red_vx;
                    tmp29 = _red_vx * tmp28;
                    tmp30 = tmp27 + tmp29;
                    tmp31 = 0x1.cede63102cdbbp-4 * _red_vx;
                    tmp32 = _red_vx2_ * tmp31;
                    tmp33 = tmp30 + tmp32;
                    tmp34 = -0x1.99a59b12decebp-4 * _red_vx;
                    tmp35 = -0x1.7b00b9a789cacp3 * _red_vx;
                    tmp36 = _red_vx * tmp35;
                    tmp37 = tmp34 + tmp36;
                    tmp38 = _red_vx3_ * tmp37;
                    tmp39 = tmp33 + tmp38;
                    _red_vx4_ = _red_vx2_ * _red_vx2_;
                    _red_vx5_ = _red_vx * _red_vx4_;
                    tmp40 = _red_vx5_ * tmp39;
                    poly = tmp26 + tmp40;
                    tmp41 = _red_vx * poly;
                    log_inv_lo = ml_log_10_inv_table[table_index][INT32_C(1)];
                    _vx_exp = ml_exp_extraction_dirty_fp64(tmp);
                    tmp42 = _vx_exp + INT32_C(-100);
                    id_tmp2 = tmp42;
                    tmp43 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                    tmp44 = tmp43 - log_inv_lo;
                    tmp45 = tmp41 + tmp44;
                    tmp46 = _red_vx + tmp45;
                    pre_result = tmp3 + tmp46;
                    exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
                    tmp47 = exact_log2_hi_exp + pre_result;
                    return tmp47;
                }
            } else {
                int vx_one;
                ...
                if (__builtin_expect(vx_one, 0)) {
                    ...
                    if (__builtin_expect(exp_minus_one, 0)) {
                        ...
                        tmp41 = poly * _red_vx;
                        tmp42 = _red_vx + tmp41;
                        tmp43 = tmp42 - -0x1.8432a1b0e2634p-43;
                        tmp44 = tmp43 - log_inv_lo;
                        result2 = tmp3 + tmp44;
                        return result2;
                    } else {
                        ...
                        tmp21 = -0x1.5555555555654p-3 * _red_vx;
                        tmp22 = _red_vx * tmp21;
                        tmp23 = tmp20 + tmp22;
                        _red_vx3_ = _red_vx * _red_vx2_;
                        tmp24 = _red_vx3_ * tmp23;
                        tmp25 = tmp19 + tmp24;
                        tmp26 = 0x1.24923aebad86cp-3 * _red_vx;
                        tmp27 = -0x1.ffffffdd4c37cp-4 * _red_vx;
                        tmp28 = _red_vx * tmp27;
                        tmp29 = tmp26 + tmp28;
                        tmp30 = 0x1.cede63102cdbbp-4 * _red_vx;
                        tmp31 = _red_vx2_ * tmp30;
                        tmp32 = tmp29 + tmp31;
                        tmp33 = -0x1.99a59b12decebp-4 * _red_vx;
                        tmp34 = -0x1.7b00b9a789cacp3 * _red_vx;
                        tmp35 = _red_vx * tmp34;
                        tmp36 = tmp33 + tmp35;
                        tmp37 = _red_vx3_ * tmp36;
                        tmp38 = tmp32 + tmp37;
                        _red_vx4_ = _red_vx2_ * _red_vx2_;
                        _red_vx5_ = _red_vx * _red_vx4_;
                        tmp39 = _red_vx5_ * tmp38;
                        poly = tmp25 + tmp39;
                        tmp40 = _red_vx * poly;
                        log_inv_lo = ml_log_10_inv_table[table_index][INT32_C(1)];
                        _vx_exp = ml_exp_extraction_dirty_fp64(x);
                        id_tmp2 = _vx_exp;
                        tmp41 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                        tmp42 = tmp41 - log_inv_lo;
                        tmp43 = tmp40 + tmp42;
                        tmp44 = _red_vx + tmp43;
                        pre_result = tmp2 + tmp44;
                        exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
...
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassSubExpressionSharing object at 0x7f4942df9910> at <class 'metalibm_core.core.passes.PassScheduler.Optimization'>
//Info: inserting instantiate abstract precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiateAbstractPrecision object at 0x7f4942df9550> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting instantiate precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiatePrecision object at 0x7f4942df9460> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting target support check pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassCheckProcessorSupport object at 0x7f4942df9280> at <class 'metalibm_core.core.passes.PassScheduler.JustBeforeCodeGen'>
...
//Info: executing pass instantiate_abstract_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f4942df90a0>
//Info: executing pass instantiate_abstract_prec on fct ml_log_10
//Info: executing pass: instantiate_prec
//Info: executing pass instantiate_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f4942df90a0>
//Info: executing pass instantiate_prec on fct ml_log_10
//Info: Applying <Optimization> stage passes
//Info: executing pass: sub_expr_sharing
//Info: executing pass sub_expr_sharing on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f4942df90a0>
//Info: executing pass sub_expr_sharing on fct ml_log_10
//Info: Applying <JustBeforeCodeGen> stage passes
//Info: executing pass: check_processor_support
//Info: executing pass check_processor_support on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f4942df90a0>
//Info: executing pass check_processor_support on fct ml_log_10
//Info: executing check-processor with target generic
//Info: checking processor support: <class 'metalibm_core.code_generation.generic_processor.GenericProcessor'>
//Info: executing pass: debug_tag_node
//Info: executing pass debug_tag_node on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f4942df90a0>
//Info: executing pass debug_tag_node on fct ml_log_10
//Info: Generating Source Code 
//Info: Generating C_Code code in src/ml_log_10.c

 ...
 *   scripts/ml_log.py --precision double --output src/ml_log_16.c \
 *     --poly-degree 16 --fname ml_log_16 --verbose Info
 * 
**/
#include <stdint.h>
#include <fenv.h>
...
static const double ml_log_16_inv_table[128][2]  = {
    { 0.0, 0.0},
        ...
        if (__builtin_expect(nan_or_inf, 0)) {
            ...
            if (__builtin_expect(vx_subnormal, 0)) {
                ...
                if (__builtin_expect(vx_zero, 0)) {
                    ...
                    log_inv_hi = ml_log_16_inv_table[table_index][INT32_C(0)];
                    tmp3 =  - log_inv_hi;
                    id_tmp = _vx_mant;
                    ...
                    tmp19 = 0x1.99999999ceeefp-3 * _red_vx;
                    tmp20 = _red_vx * tmp19;
                    tmp21 = tmp18 + tmp20;
                    _red_vx2_ = _red_vx * _red_vx;
                    tmp22 = _red_vx2_ * tmp21;
                    tmp23 = tmp17 + tmp22;
                    tmp24 = -0x1.5555555555556p-3 * _red_vx;
                    tmp25 = 0x1.2491e75d713c2p-3 * _red_vx;
                    tmp26 = _red_vx * tmp25;
                    tmp27 = tmp24 + tmp26;
                    tmp28 = -0x1.ffffffffd4d46p-4 * _red_vx;
                    tmp29 = 0x1.3c71cdc6d0d02p-3 * _red_vx;
                    tmp30 = _red_vx * tmp29;
                    tmp31 = tmp28 + tmp30;
                    tmp32 = _red_vx2_ * tmp31;
                    tmp33 = tmp27 + tmp32;
                    _red_vx4_ = _red_vx2_ * _red_vx2_;
                    tmp34 = _red_vx4_ * tmp33;
                    tmp35 = tmp23 + tmp34;
                    tmp36 = -0x1.9999baa65eec4p-4 * _red_vx;
                    tmp37 = -0x1.63888b873caeap10 * _red_vx;
                    tmp38 = _red_vx * tmp37;
                    tmp39 = tmp36 + tmp38;
                    tmp40 = -0x1.4932323dfbd7p-4 * _red_vx;
                    tmp41 = 0x1.8e3915d232986p24 * _red_vx;
                    tmp42 = _red_vx * tmp41;
                    tmp43 = tmp40 + tmp42;
                    tmp44 = _red_vx2_ * tmp43;
                    tmp45 = tmp39 + tmp44;
                    tmp46 = -0x1.14a229db92293p5 * _red_vx;
                    tmp47 = -0x1.d47f6f5e0ca09p37 * _red_vx;
                    tmp48 = _red_vx * tmp47;
                    tmp49 = tmp46 + tmp48;
                    tmp50 = 0x1.319b73fe56555p17 * _red_vx;
                    tmp51 = 0x1.c2e29eb5f7572p49 * _red_vx;
                    tmp52 = _red_vx * tmp51;
                    tmp53 = tmp50 + tmp52;
                    tmp54 = _red_vx2_ * tmp53;
                    tmp55 = tmp49 + tmp54;
                    tmp56 = _red_vx4_ * tmp55;
                    tmp57 = tmp45 + tmp56;
                    _red_vx8_ = _red_vx4_ * _red_vx4_;
                    tmp58 = _red_vx8_ * tmp57;
                    poly = tmp35 + tmp58;
                    tmp59 = _red_vx * poly;
                    log_inv_lo = ml_log_16_inv_table[table_index][INT32_C(1)];
                    _vx_exp = ml_exp_extraction_dirty_fp64(tmp);
                    tmp60 = _vx_exp + INT32_C(-100);
                    id_tmp2 = tmp60;
                    tmp61 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                    tmp62 = tmp61 - log_inv_lo;
                    tmp63 = tmp59 + tmp62;
                    tmp64 = _red_vx + tmp63;
                    pre_result = tmp3 + tmp64;
                    exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
                    tmp65 = exact_log2_hi_exp + pre_result;
                    return tmp65;
                }
            } else {
                int vx_one;
                ...
                if (__builtin_expect(vx_one, 0)) {
                    ...
                    if (__builtin_expect(exp_minus_one, 0)) {
                        ...
                        tmp59 = poly * _red_vx;
                        tmp60 = _red_vx + tmp59;
                        tmp61 = tmp60 - -0x1.8432a1b0e2634p-43;
                        tmp62 = tmp61 - log_inv_lo;
                        result2 = tmp3 + tmp62;
                        return result2;
                    } else {
                        ...
                        tmp18 = 0x1.99999999ceeefp-3 * _red_vx;
                        tmp19 = _red_vx * tmp18;
                        tmp20 = tmp17 + tmp19;
                        _red_vx2_ = _red_vx * _red_vx;
                        tmp21 = _red_vx2_ * tmp20;
                        tmp22 = tmp16 + tmp21;
                        tmp23 = -0x1.5555555555556p-3 * _red_vx;
                        tmp24 = 0x1.2491e75d713c2p-3 * _red_vx;
                        tmp25 = _red_vx * tmp24;
                        tmp26 = tmp23 + tmp25;
                        tmp27 = -0x1.ffffffffd4d46p-4 * _red_vx;
                        tmp28 = 0x1.3c71cdc6d0d02p-3 * _red_vx;
                        tmp29 = _red_vx * tmp28;
                        tmp30 = tmp27 + tmp29;
                        tmp31 = _red_vx2_ * tmp30;
                        tmp32 = tmp26 + tmp31;
                        _red_vx4_ = _red_vx2_ * _red_vx2_;
                        tmp33 = _red_vx4_ * tmp32;
                        tmp34 = tmp22 + tmp33;
                        tmp35 = -0x1.9999baa65eec4p-4 * _red_vx;
                        tmp36 = -0x1.63888b873caeap10 * _red_vx;
                        tmp37 = _red_vx * tmp36;
                        tmp38 = tmp35 + tmp37;
                        tmp39 = -0x1.4932323dfbd7p-4 * _red_vx;
                        tmp40 = 0x1.8e3915d232986p24 * _red_vx;
                        tmp41 = _red_vx * tmp40;
                        tmp42 = tmp39 + tmp41;
                        tmp43 = _red_vx2_ * tmp42;
                        tmp44 = tmp38 + tmp43;
                        tmp45 = -0x1.14a229db92293p5 * _red_vx;
                        tmp46 = -0x1.d47f6f5e0ca09p37 * _red_vx;
                        tmp47 = _red_vx * tmp46;
                        tmp48 = tmp45 + tmp47;
                        tmp49 = 0x1.319b73fe56555p17 * _red_vx;
                        tmp50 = 0x1.c2e29eb5f7572p49 * _red_vx;
                        tmp51 = _red_vx * tmp50;
                        tmp52 = tmp49 + tmp51;
                        tmp53 = _red_vx2_ * tmp52;
                        tmp54 = tmp48 + tmp53;
                        tmp55 = _red_vx4_ * tmp54;
                        tmp56 = tmp44 + tmp55;
                        _red_vx8_ = _red_vx4_ * _red_vx4_;
                        tmp57 = _red_vx8_ * tmp56;
                        poly = tmp34 + tmp57;
                        tmp58 = _red_vx * poly;
                        log_inv_lo = ml_log_16_inv_table[table_index][INT32_C(1)];
                        _vx_exp = ml_exp_extraction_dirty_fp64(x);
                        id_tmp2 = _vx_exp;
                        tmp59 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                        tmp60 = tmp59 - log_inv_lo;
                        tmp61 = tmp58 + tmp60;
                        tmp62 = _red_vx + tmp61;
                        pre_result = tmp2 + tmp62;
                        exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
...
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassSubExpressionSharing object at 0x7fc8d94b5910> at <class 'metalibm_core.core.passes.PassScheduler.Optimization'>
//Info: inserting instantiate abstract precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiateAbstractPrecision object at 0x7fc8d94b5550> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting instantiate precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiatePrecision object at 0x7fc8d94b5460> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting target support check pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassCheckProcessorSupport object at 0x7fc8d94b5280> at <class 'metalibm_core.core.passes.PassScheduler.JustBeforeCodeGen'>
...
//Info: executing pass instantiate_abstract_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7fc8d94b50a0>
//Info: executing pass instantiate_abstract_prec on fct ml_log_16
//Info: executing pass: instantiate_prec
//Info: executing pass instantiate_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7fc8d94b50a0>
//Info: executing pass instantiate_prec on fct ml_log_16
//Info: Applying <Optimization> stage passes
//Info: executing pass: sub_expr_sharing
//Info: executing pass sub_expr_sharing on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7fc8d94b50a0>
//Info: executing pass sub_expr_sharing on fct ml_log_16
//Info: Applying <JustBeforeCodeGen> stage passes
//Info: executing pass: check_processor_support
//Info: executing pass check_processor_support on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7fc8d94b50a0>
//Info: executing pass check_processor_support on fct ml_log_16
//Info: executing check-processor with target generic
//Info: checking processor support: <class 'metalibm_core.code_generation.generic_processor.GenericProcessor'>
//Info: executing pass: debug_tag_node
//Info: executing pass debug_tag_node on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7fc8d94b50a0>
//Info: executing pass debug_tag_node on fct ml_log_16
//Info: Generating Source Code 
//Info: Generating C_Code code in src/ml_log_16.c

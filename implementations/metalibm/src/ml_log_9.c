 ...
 *   scripts/ml_log.py --precision double --output src/ml_log_9.c \
 *     --poly-degree 9 --fname ml_log_9 --verbose Info
 * 
**/
#include <stdint.h>
#include <fenv.h>
...
static const double ml_log_9_inv_table[128][2]  = {
    { 0.0, 0.0},
        ...
        if (__builtin_expect(nan_or_inf, 0)) {
            ...
            if (__builtin_expect(vx_subnormal, 0)) {
                ...
                if (__builtin_expect(vx_zero, 0)) {
                    ...
                    log_inv_hi = ml_log_9_inv_table[table_index][INT32_C(0)];
                    tmp3 =  - log_inv_hi;
                    id_tmp = _vx_mant;
                    ...
                    tmp20 = tmp17 + tmp19;
                    tmp21 = 0x1.99999999a75f5p-3 * _red_vx;
                    tmp22 = -0x1.5555555555484p-3 * _red_vx;
                    tmp23 = _red_vx * tmp22;
                    tmp24 = tmp21 + tmp23;
                    _red_vx3_ = _red_vx * _red_vx2_;
                    tmp25 = _red_vx3_ * tmp24;
                    tmp26 = tmp20 + tmp25;
                    tmp27 = 0x1.249243bde7bd2p-3 * _red_vx;
                    tmp28 = -0x1.000000011a55ap-3 * _red_vx;
                    tmp29 = _red_vx * tmp28;
                    tmp30 = tmp27 + tmp29;
                    tmp31 = 0x1.c8740a6a09f29p-4 * _red_vx;
                    tmp32 = -0x1.999fed7f3ee8fp-4 * _red_vx;
                    tmp33 = _red_vx * tmp32;
                    tmp34 = tmp31 + tmp33;
                    ...
                    tmp37 = _red_vx5_ * tmp36;
                    poly = tmp26 + tmp37;
                    tmp38 = _red_vx * poly;
                    log_inv_lo = ml_log_9_inv_table[table_index][INT32_C(1)];
                    _vx_exp = ml_exp_extraction_dirty_fp64(tmp);
                    tmp39 = _vx_exp + INT32_C(-100);
                    id_tmp2 = tmp39;
                    tmp40 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                    tmp41 = tmp40 - log_inv_lo;
                    tmp42 = tmp38 + tmp41;
                    tmp43 = _red_vx + tmp42;
                    pre_result = tmp3 + tmp43;
                    exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
                    tmp44 = exact_log2_hi_exp + pre_result;
                    return tmp44;
                }
            } else {
                int vx_one;
                ...
                if (__builtin_expect(vx_one, 0)) {
                    ...
                    if (__builtin_expect(exp_minus_one, 0)) {
                        ...
                        tmp38 = poly * _red_vx;
                        tmp39 = _red_vx + tmp38;
                        tmp40 = tmp39 - -0x1.8432a1b0e2634p-43;
                        tmp41 = tmp40 - log_inv_lo;
                        result2 = tmp3 + tmp41;
                        return result2;
                    } else {
                        ...
                        tmp19 = tmp16 + tmp18;
                        tmp20 = 0x1.99999999a75f5p-3 * _red_vx;
                        tmp21 = -0x1.5555555555484p-3 * _red_vx;
                        tmp22 = _red_vx * tmp21;
                        tmp23 = tmp20 + tmp22;
                        _red_vx3_ = _red_vx * _red_vx2_;
                        tmp24 = _red_vx3_ * tmp23;
                        tmp25 = tmp19 + tmp24;
                        tmp26 = 0x1.249243bde7bd2p-3 * _red_vx;
                        tmp27 = -0x1.000000011a55ap-3 * _red_vx;
                        tmp28 = _red_vx * tmp27;
                        tmp29 = tmp26 + tmp28;
                        tmp30 = 0x1.c8740a6a09f29p-4 * _red_vx;
                        tmp31 = -0x1.999fed7f3ee8fp-4 * _red_vx;
                        tmp32 = _red_vx * tmp31;
                        tmp33 = tmp30 + tmp32;
                        ...
                        _red_vx4_ = _red_vx2_ * _red_vx2_;
                        _red_vx5_ = _red_vx * _red_vx4_;
                        tmp36 = _red_vx5_ * tmp35;
                        poly = tmp25 + tmp36;
                        tmp37 = _red_vx * poly;
                        log_inv_lo = ml_log_9_inv_table[table_index][INT32_C(1)];
                        _vx_exp = ml_exp_extraction_dirty_fp64(x);
                        id_tmp2 = _vx_exp;
                        tmp38 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                        tmp39 = tmp38 - log_inv_lo;
                        tmp40 = tmp37 + tmp39;
                        tmp41 = _red_vx + tmp40;
                        pre_result = tmp2 + tmp41;
                        exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
...
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassSubExpressionSharing object at 0x7f1d4da33910> at <class 'metalibm_core.core.passes.PassScheduler.Optimization'>
//Info: inserting instantiate abstract precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiateAbstractPrecision object at 0x7f1d4da33550> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting instantiate precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiatePrecision object at 0x7f1d4da33460> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting target support check pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassCheckProcessorSupport object at 0x7f1d4da33280> at <class 'metalibm_core.core.passes.PassScheduler.JustBeforeCodeGen'>
...
//Info: executing pass instantiate_abstract_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f1d4da330a0>
//Info: executing pass instantiate_abstract_prec on fct ml_log_9
//Info: executing pass: instantiate_prec
//Info: executing pass instantiate_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f1d4da330a0>
//Info: executing pass instantiate_prec on fct ml_log_9
//Info: Applying <Optimization> stage passes
//Info: executing pass: sub_expr_sharing
//Info: executing pass sub_expr_sharing on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f1d4da330a0>
//Info: executing pass sub_expr_sharing on fct ml_log_9
//Info: Applying <JustBeforeCodeGen> stage passes
//Info: executing pass: check_processor_support
//Info: executing pass check_processor_support on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f1d4da330a0>
//Info: executing pass check_processor_support on fct ml_log_9
//Info: executing check-processor with target generic
//Info: checking processor support: <class 'metalibm_core.code_generation.generic_processor.GenericProcessor'>
//Info: executing pass: debug_tag_node
//Info: executing pass debug_tag_node on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f1d4da330a0>
//Info: executing pass debug_tag_node on fct ml_log_9
//Info: Generating Source Code 
//Info: Generating C_Code code in src/ml_log_9.c

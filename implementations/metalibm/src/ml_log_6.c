 ...
 *   scripts/ml_log.py --precision double --output src/ml_log_6.c \
 *     --poly-degree 6 --fname ml_log_6 --verbose Info
 * 
**/
#include <stdint.h>
#include <fenv.h>
...
static const double ml_log_6_inv_table[128][2]  = {
    { 0.0, 0.0},
        ...
        if (__builtin_expect(nan_or_inf, 0)) {
            ...
            if (__builtin_expect(vx_subnormal, 0)) {
                ...
                if (__builtin_expect(vx_zero, 0)) {
                    ...
                    log_inv_hi = ml_log_6_inv_table[table_index][INT32_C(0)];
                    tmp3 =  - log_inv_hi;
                    id_tmp = _vx_mant;
                    ...
                    tmp14 = -0x1.000000000001cp-1 * _red_vx;
                    tmp15 = 0x1.55555555555cep-2 * _red_vx;
                    tmp16 = _red_vx * tmp15;
                    tmp17 = tmp14 + tmp16;
                    tmp18 = -0x1.fffffff1ffd5cp-3 * _red_vx;
                    _red_vx2_ = _red_vx * _red_vx;
                    tmp19 = _red_vx2_ * tmp18;
                    tmp20 = tmp17 + tmp19;
                    tmp21 = 0x1.999999861044ap-3 * _red_vx;
                    tmp22 = -0x1.555c556bf71ep-3 * _red_vx;
                    tmp23 = _red_vx * tmp22;
                    tmp24 = tmp21 + tmp23;
                    tmp25 = 0x1.2499c65b12a5fp-3 * _red_vx;
                    ...
                    poly = tmp20 + tmp28;
                    tmp29 = _red_vx * poly;
                    log_inv_lo = ml_log_6_inv_table[table_index][INT32_C(1)];
                    _vx_exp = ml_exp_extraction_dirty_fp64(tmp);
                    tmp30 = _vx_exp + INT32_C(-100);
                    id_tmp2 = tmp30;
                    tmp31 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                    tmp32 = tmp31 - log_inv_lo;
                    tmp33 = tmp29 + tmp32;
                    tmp34 = _red_vx + tmp33;
                    pre_result = tmp3 + tmp34;
                    exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
                    tmp35 = exact_log2_hi_exp + pre_result;
                    return tmp35;
                }
            } else {
                int vx_one;
                ...
                if (__builtin_expect(vx_one, 0)) {
                    ...
                    if (__builtin_expect(exp_minus_one, 0)) {
                        ...
                        tmp29 = poly * _red_vx;
                        tmp30 = _red_vx + tmp29;
                        tmp31 = tmp30 - -0x1.8432a1b0e2634p-43;
                        tmp32 = tmp31 - log_inv_lo;
                        result2 = tmp3 + tmp32;
                        return result2;
                    } else {
                        ...
                        tmp13 = -0x1.000000000001cp-1 * _red_vx;
                        tmp14 = 0x1.55555555555cep-2 * _red_vx;
                        tmp15 = _red_vx * tmp14;
                        tmp16 = tmp13 + tmp15;
                        tmp17 = -0x1.fffffff1ffd5cp-3 * _red_vx;
                        _red_vx2_ = _red_vx * _red_vx;
                        tmp18 = _red_vx2_ * tmp17;
                        tmp19 = tmp16 + tmp18;
                        tmp20 = 0x1.999999861044ap-3 * _red_vx;
                        tmp21 = -0x1.555c556bf71ep-3 * _red_vx;
                        tmp22 = _red_vx * tmp21;
                        tmp23 = tmp20 + tmp22;
                        tmp24 = 0x1.2499c65b12a5fp-3 * _red_vx;
                        ...
                        id_tmp2 = _vx_exp;
                        tmp29 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                        tmp30 = tmp29 - log_inv_lo;
                        tmp31 = tmp28 + tmp30;
                        tmp32 = _red_vx + tmp31;
                        pre_result = tmp2 + tmp32;
                        exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
...
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassSubExpressionSharing object at 0x7f7e402cd910> at <class 'metalibm_core.core.passes.PassScheduler.Optimization'>
//Info: inserting instantiate abstract precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiateAbstractPrecision object at 0x7f7e402cd550> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting instantiate precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiatePrecision object at 0x7f7e402cd460> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting target support check pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassCheckProcessorSupport object at 0x7f7e402cd280> at <class 'metalibm_core.core.passes.PassScheduler.JustBeforeCodeGen'>
...
//Info: executing pass instantiate_abstract_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f7e402cd0a0>
//Info: executing pass instantiate_abstract_prec on fct ml_log_6
//Info: executing pass: instantiate_prec
//Info: executing pass instantiate_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f7e402cd0a0>
//Info: executing pass instantiate_prec on fct ml_log_6
//Info: Applying <Optimization> stage passes
//Info: executing pass: sub_expr_sharing
//Info: executing pass sub_expr_sharing on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f7e402cd0a0>
//Info: executing pass sub_expr_sharing on fct ml_log_6
//Info: Applying <JustBeforeCodeGen> stage passes
//Info: executing pass: check_processor_support
//Info: executing pass check_processor_support on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f7e402cd0a0>
//Info: executing pass check_processor_support on fct ml_log_6
//Info: executing check-processor with target generic
//Info: checking processor support: <class 'metalibm_core.code_generation.generic_processor.GenericProcessor'>
//Info: executing pass: debug_tag_node
//Info: executing pass debug_tag_node on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f7e402cd0a0>
//Info: executing pass debug_tag_node on fct ml_log_6
//Info: Generating Source Code 
//Info: Generating C_Code code in src/ml_log_6.c

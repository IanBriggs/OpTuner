 ...
 *   scripts/ml_log.py --precision double --output src/ml_log_3.c \
 *     --poly-degree 3 --fname ml_log_3 --verbose Info
 * 
**/
#include <stdint.h>
#include <fenv.h>
...
static const double ml_log_3_inv_table[128][2]  = {
    { 0.0, 0.0},
        ...
        if (__builtin_expect(nan_or_inf, 0)) {
            ...
            if (__builtin_expect(vx_subnormal, 0)) {
                ...
                if (__builtin_expect(vx_zero, 0)) {
                    ...
                    log_inv_hi = ml_log_3_inv_table[table_index][INT32_C(0)];
                    tmp3 =  - log_inv_hi;
                    id_tmp = _vx_mant;
                    ...
                    tmp14 = -0x1.fffffffa553ap-2 * _red_vx;
                    tmp15 = 0x1.55580006b2792p-2 * _red_vx;
                    tmp16 = _red_vx * tmp15;
                    tmp17 = tmp14 + tmp16;
                    tmp18 = -0x1.00041c80be26fp-2 * _red_vx;
                    _red_vx2_ = _red_vx * _red_vx;
                    tmp19 = _red_vx2_ * tmp18;
                    poly = tmp17 + tmp19;
                    tmp20 = _red_vx * poly;
                    log_inv_lo = ml_log_3_inv_table[table_index][INT32_C(1)];
                    _vx_exp = ml_exp_extraction_dirty_fp64(tmp);
                    tmp21 = _vx_exp + INT32_C(-100);
                    id_tmp2 = tmp21;
                    tmp22 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                    tmp23 = tmp22 - log_inv_lo;
                    tmp24 = tmp20 + tmp23;
                    tmp25 = _red_vx + tmp24;
                    pre_result = tmp3 + tmp25;
                    exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
                    tmp26 = exact_log2_hi_exp + pre_result;
                    return tmp26;
                }
            } else {
                int vx_one;
                ...
                if (__builtin_expect(vx_one, 0)) {
                    ...
                    if (__builtin_expect(exp_minus_one, 0)) {
                        ...
                        tmp20 = poly * _red_vx;
                        tmp21 = _red_vx + tmp20;
                        tmp22 = tmp21 - -0x1.8432a1b0e2634p-43;
                        tmp23 = tmp22 - log_inv_lo;
                        result2 = tmp3 + tmp23;
                        return result2;
                    } else {
                        ...
                        tmp13 = -0x1.fffffffa553ap-2 * _red_vx;
                        tmp14 = 0x1.55580006b2792p-2 * _red_vx;
                        tmp15 = _red_vx * tmp14;
                        tmp16 = tmp13 + tmp15;
                        tmp17 = -0x1.00041c80be26fp-2 * _red_vx;
                        _red_vx2_ = _red_vx * _red_vx;
                        ...
                        id_tmp2 = _vx_exp;
                        tmp20 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                        tmp21 = tmp20 - log_inv_lo;
                        tmp22 = tmp19 + tmp21;
                        tmp23 = _red_vx + tmp22;
                        pre_result = tmp2 + tmp23;
                        exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
...
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassSubExpressionSharing object at 0x7f862c7ac910> at <class 'metalibm_core.core.passes.PassScheduler.Optimization'>
//Info: inserting instantiate abstract precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiateAbstractPrecision object at 0x7f862c7ac550> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting instantiate precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiatePrecision object at 0x7f862c7ac460> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting target support check pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassCheckProcessorSupport object at 0x7f862c7ac280> at <class 'metalibm_core.core.passes.PassScheduler.JustBeforeCodeGen'>
...
//Info: executing pass instantiate_abstract_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f862c7ac0a0>
//Info: executing pass instantiate_abstract_prec on fct ml_log_3
//Info: executing pass: instantiate_prec
//Info: executing pass instantiate_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f862c7ac0a0>
//Info: executing pass instantiate_prec on fct ml_log_3
//Info: Applying <Optimization> stage passes
//Info: executing pass: sub_expr_sharing
//Info: executing pass sub_expr_sharing on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f862c7ac0a0>
//Info: executing pass sub_expr_sharing on fct ml_log_3
//Info: Applying <JustBeforeCodeGen> stage passes
//Info: executing pass: check_processor_support
//Info: executing pass check_processor_support on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f862c7ac0a0>
//Info: executing pass check_processor_support on fct ml_log_3
//Info: executing check-processor with target generic
//Info: checking processor support: <class 'metalibm_core.code_generation.generic_processor.GenericProcessor'>
//Info: executing pass: debug_tag_node
//Info: executing pass debug_tag_node on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f862c7ac0a0>
//Info: executing pass debug_tag_node on fct ml_log_3
//Info: Generating Source Code 
//Info: Generating C_Code code in src/ml_log_3.c

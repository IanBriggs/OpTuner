 ...
 *   scripts/ml_log.py --precision double --output src/ml_log_7.c \
 *     --poly-degree 7 --fname ml_log_7 --verbose Info
 * 
**/
#include <stdint.h>
#include <fenv.h>
...
static const double ml_log_7_inv_table[128][2]  = {
    { 0.0, 0.0},
        ...
        if (__builtin_expect(nan_or_inf, 0)) {
            ...
            if (__builtin_expect(vx_subnormal, 0)) {
                ...
                if (__builtin_expect(vx_zero, 0)) {
                    ...
                    log_inv_hi = ml_log_7_inv_table[table_index][INT32_C(0)];
                    tmp3 =  - log_inv_hi;
                    id_tmp = _vx_mant;
                    ...
                    tmp15 = 0x1.55555555555abp-2 * _red_vx;
                    tmp16 = _red_vx * tmp15;
                    tmp17 = tmp14 + tmp16;
                    tmp18 = -0x1.0000000000081p-2 * _red_vx;
                    tmp19 = 0x1.9999998991ce9p-3 * _red_vx;
                    tmp20 = _red_vx * tmp19;
                    tmp21 = tmp18 + tmp20;
                    _red_vx2_ = _red_vx * _red_vx;
                    tmp22 = _red_vx2_ * tmp21;
                    tmp23 = tmp17 + tmp22;
                    tmp24 = -0x1.5555554245f7fp-3 * _red_vx;
                    tmp25 = 0x1.249925eda60a2p-3 * _red_vx;
                    tmp26 = _red_vx * tmp25;
                    tmp27 = tmp24 + tmp26;
                    tmp28 = -0x1.0006f2bb07277p-3 * _red_vx;
                    ...
                    poly = tmp23 + tmp31;
                    tmp32 = _red_vx * poly;
                    log_inv_lo = ml_log_7_inv_table[table_index][INT32_C(1)];
                    _vx_exp = ml_exp_extraction_dirty_fp64(tmp);
                    tmp33 = _vx_exp + INT32_C(-100);
                    id_tmp2 = tmp33;
                    tmp34 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                    tmp35 = tmp34 - log_inv_lo;
                    tmp36 = tmp32 + tmp35;
                    tmp37 = _red_vx + tmp36;
                    pre_result = tmp3 + tmp37;
                    exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
                    tmp38 = exact_log2_hi_exp + pre_result;
                    return tmp38;
                }
            } else {
                int vx_one;
                ...
                if (__builtin_expect(vx_one, 0)) {
                    ...
                    if (__builtin_expect(exp_minus_one, 0)) {
                        ...
                        tmp32 = poly * _red_vx;
                        tmp33 = _red_vx + tmp32;
                        tmp34 = tmp33 - -0x1.8432a1b0e2634p-43;
                        tmp35 = tmp34 - log_inv_lo;
                        result2 = tmp3 + tmp35;
                        return result2;
                    } else {
                        ...
                        tmp14 = 0x1.55555555555abp-2 * _red_vx;
                        tmp15 = _red_vx * tmp14;
                        tmp16 = tmp13 + tmp15;
                        tmp17 = -0x1.0000000000081p-2 * _red_vx;
                        tmp18 = 0x1.9999998991ce9p-3 * _red_vx;
                        tmp19 = _red_vx * tmp18;
                        tmp20 = tmp17 + tmp19;
                        _red_vx2_ = _red_vx * _red_vx;
                        tmp21 = _red_vx2_ * tmp20;
                        tmp22 = tmp16 + tmp21;
                        tmp23 = -0x1.5555554245f7fp-3 * _red_vx;
                        tmp24 = 0x1.249925eda60a2p-3 * _red_vx;
                        tmp25 = _red_vx * tmp24;
                        tmp26 = tmp23 + tmp25;
                        tmp27 = -0x1.0006f2bb07277p-3 * _red_vx;
                        ...
                        id_tmp2 = _vx_exp;
                        tmp32 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                        tmp33 = tmp32 - log_inv_lo;
                        tmp34 = tmp31 + tmp33;
                        tmp35 = _red_vx + tmp34;
                        pre_result = tmp2 + tmp35;
                        exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
...
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassSubExpressionSharing object at 0x7f61a5d9e910> at <class 'metalibm_core.core.passes.PassScheduler.Optimization'>
//Info: inserting instantiate abstract precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiateAbstractPrecision object at 0x7f61a5d9e550> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting instantiate precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiatePrecision object at 0x7f61a5d9e460> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting target support check pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassCheckProcessorSupport object at 0x7f61a5d9e280> at <class 'metalibm_core.core.passes.PassScheduler.JustBeforeCodeGen'>
...
//Info: executing pass instantiate_abstract_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f61a5d9e0a0>
//Info: executing pass instantiate_abstract_prec on fct ml_log_7
//Info: executing pass: instantiate_prec
//Info: executing pass instantiate_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f61a5d9e0a0>
//Info: executing pass instantiate_prec on fct ml_log_7
//Info: Applying <Optimization> stage passes
//Info: executing pass: sub_expr_sharing
//Info: executing pass sub_expr_sharing on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f61a5d9e0a0>
//Info: executing pass sub_expr_sharing on fct ml_log_7
//Info: Applying <JustBeforeCodeGen> stage passes
//Info: executing pass: check_processor_support
//Info: executing pass check_processor_support on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f61a5d9e0a0>
//Info: executing pass check_processor_support on fct ml_log_7
//Info: executing check-processor with target generic
//Info: checking processor support: <class 'metalibm_core.code_generation.generic_processor.GenericProcessor'>
//Info: executing pass: debug_tag_node
//Info: executing pass debug_tag_node on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f61a5d9e0a0>
//Info: executing pass debug_tag_node on fct ml_log_7
//Info: Generating Source Code 
//Info: Generating C_Code code in src/ml_log_7.c

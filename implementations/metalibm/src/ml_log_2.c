 ...
 *   scripts/ml_log.py --precision double --output src/ml_log_2.c \
 *     --poly-degree 2 --fname ml_log_2 --verbose Info
 * 
**/
#include <stdint.h>
#include <fenv.h>
...
static const double ml_log_2_inv_table[128][2]  = {
    { 0.0, 0.0},
        ...
        if (__builtin_expect(nan_or_inf, 0)) {
            ...
            if (__builtin_expect(vx_subnormal, 0)) {
                ...
                if (__builtin_expect(vx_zero, 0)) {
                    ...
                    log_inv_hi = ml_log_2_inv_table[table_index][INT32_C(0)];
                    tmp3 =  - log_inv_hi;
                    id_tmp = _vx_mant;
                    ...
                    tmp14 = -0x1.0001800358c82p-1 * _red_vx;
                    tmp15 = 0x1.5558444c3739dp-2 * _red_vx;
                    tmp16 = _red_vx * tmp15;
                    poly = tmp14 + tmp16;
                    tmp17 = _red_vx * poly;
                    log_inv_lo = ml_log_2_inv_table[table_index][INT32_C(1)];
                    _vx_exp = ml_exp_extraction_dirty_fp64(tmp);
                    tmp18 = _vx_exp + INT32_C(-100);
                    id_tmp2 = tmp18;
                    tmp19 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                    tmp20 = tmp19 - log_inv_lo;
                    tmp21 = tmp17 + tmp20;
                    tmp22 = _red_vx + tmp21;
                    pre_result = tmp3 + tmp22;
                    exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
                    tmp23 = exact_log2_hi_exp + pre_result;
                    return tmp23;
                }
            } else {
                int vx_one;
                ...
                if (__builtin_expect(vx_one, 0)) {
                    ...
                    if (__builtin_expect(exp_minus_one, 0)) {
                        ...
                        tmp17 = poly * _red_vx;
                        tmp18 = _red_vx + tmp17;
                        tmp19 = tmp18 - -0x1.8432a1b0e2634p-43;
                        tmp20 = tmp19 - log_inv_lo;
                        result2 = tmp3 + tmp20;
                        return result2;
                    } else {
                        ...
                        tmp13 = -0x1.0001800358c82p-1 * _red_vx;
                        tmp14 = 0x1.5558444c3739dp-2 * _red_vx;
                        tmp15 = _red_vx * tmp14;
                        poly = tmp13 + tmp15;
                        tmp16 = _red_vx * poly;
                        log_inv_lo = ml_log_2_inv_table[table_index][INT32_C(1)];
                        ...
                        id_tmp2 = _vx_exp;
                        tmp17 = id_tmp2 * -0x1.8432a1b0e2634p-43;
                        tmp18 = tmp17 - log_inv_lo;
                        tmp19 = tmp16 + tmp18;
                        tmp20 = _red_vx + tmp19;
                        pre_result = tmp2 + tmp20;
                        exact_log2_hi_exp = id_tmp2 * 0x1.62e42fefa4p-1;
...
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassSubExpressionSharing object at 0x7f04bfe95910> at <class 'metalibm_core.core.passes.PassScheduler.Optimization'>
//Info: inserting instantiate abstract precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiateAbstractPrecision object at 0x7f04bfe95550> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting instantiate precision pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_typing.PassInstantiatePrecision object at 0x7f04bfe95460> at <class 'metalibm_core.core.passes.PassScheduler.Typing'>
//Info: inserting target support check pass
//
//Info: PassScheduler: registering pass <metalibm_core.opt.p_function_std.PassCheckProcessorSupport object at 0x7f04bfe95280> at <class 'metalibm_core.core.passes.PassScheduler.JustBeforeCodeGen'>
...
//Info: executing pass instantiate_abstract_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f04bfe950a0>
//Info: executing pass instantiate_abstract_prec on fct ml_log_2
//Info: executing pass: instantiate_prec
//Info: executing pass instantiate_prec on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f04bfe950a0>
//Info: executing pass instantiate_prec on fct ml_log_2
//Info: Applying <Optimization> stage passes
//Info: executing pass: sub_expr_sharing
//Info: executing pass sub_expr_sharing on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f04bfe950a0>
//Info: executing pass sub_expr_sharing on fct ml_log_2
//Info: Applying <JustBeforeCodeGen> stage passes
//Info: executing pass: check_processor_support
//Info: executing pass check_processor_support on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f04bfe950a0>
//Info: executing pass check_processor_support on fct ml_log_2
//Info: executing check-processor with target generic
//Info: checking processor support: <class 'metalibm_core.code_generation.generic_processor.GenericProcessor'>
//Info: executing pass: debug_tag_node
//Info: executing pass debug_tag_node on fct group <metalibm_core.code_generation.code_function.FunctionGroup object at 0x7f04bfe950a0>
//Info: executing pass debug_tag_node on fct ml_log_2
//Info: Generating Source Code 
//Info: Generating C_Code code in src/ml_log_2.c
